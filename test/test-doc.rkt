...
(check-equal?
 ...
 '(root
   ...
   (h1 "Pollen heading")
   (p "Simple paragraph.")
   (p "This is paragrpah with " (em "markdown emphasis") ".")
   (p "This is paragraph with " (em "pollen emphasis") ".")
   (p "This is paragrpah with " (strong "markdown strong emphasis") ".")
   (p "This is paragrpah with " (strong "pollen strong emphasis") ".")
